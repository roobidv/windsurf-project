...
' Date: 31/03/2026
' Purpose: Utility functions for Access database operations
' ============================================================================
...
Public Function GetCurrentDatabase() As Database
...
Public Function RunSelectQuery(ByVal queryName As String, Optional ByVal parameters As Variant) As Recordset
