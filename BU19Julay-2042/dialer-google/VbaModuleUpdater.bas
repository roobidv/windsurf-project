...
' הבטחת גישה ל-VBE - מפעיל גישה תכנותית לפרויקט VBA
...
' מציאת או יצירת מודול - מחזיר מודול קיים או יוצר חדש
...
' קריאת קובץ עברי - קורא קובץ בקידוד ANSI 1255
...
' נרמול קוד VBA - מסיר שורות Attribute ורווחים מיותרים
