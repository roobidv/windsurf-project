...
' ===========================================================================
' מודול: DialerFixup
' תיאור: פונקציות תיקון ובנייה חד-פעמיות לטופס frmContactsDialer
' הרצה: מחלון Immediate בלבד
' ===========================================================================

' ---------------------------------------------------------------------------
' AddOutOfOfficeControls
' תיאור: יוצר את פקדי "מחוץ למשרד" בטופס frmContactsDialer
'   - optOutOfOffice: כפתור Toggle לסימון מצב "מחוץ למשרד"
'   - txtOOF: תיבת טקסט המציגה את מצב הנוכחות
' מיקום: מתחת ל-Box223 (כפתורי חיוג מהיר 10-18)
' הרצה מ-Immediate:  AddOutOfOfficeControls
' ---------------------------------------------------------------------------
Public Sub AddOutOfOfficeControls()
    ...
    ' קריאת מיקום Box223 (מכיל כפתורי חיוג מהיר 10-18)
    ...
    Debug.Print "AddOutOfOfficeControls: הפקדים נוצרו בהצלחה!"
...
' Manager writes messages directly in Google Sheets sheet "׳”׳•׳“׳¢׳•׳×"
