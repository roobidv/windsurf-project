...
' ---------------------------------------------------------------------------
' בדיקת נגישות שרת - פינג מהיר לבדיקה אם Florence זמין
...
' ---------------------------------------------------------------------------
' סנכרון ספר טלפונים - נקודת כניסה ראשית לסנכרון עם Florence
' [מיושן - הוחלף בסנכרון Google Sheet]
...
' ---------------------------------------------------------------------------
' דחיפה לשרת - מעביר רשומות מקומיות חדשות ל-Florence
...
' ---------------------------------------------------------------------------
' משיכה מהשרת - מוריד רשומות חדשות מ-Florence
...
' ---------------------------------------------------------------------------
' הבטחת טבלת מאסטר - יוצר את הטבלה ב-Florence אם חסרה
