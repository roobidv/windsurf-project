...
' רישום שגיאה - מתעד שגיאה בטבלת לוג עם מקור, מספר ותיאור
...
' הצגת לוג שגיאות - פותח את טבלת tblErrorLog בתצוגת Datasheet
...
' ניקוי לוג שגיאות - מוחק את כל הרשומות מטבלת tblErrorLog
