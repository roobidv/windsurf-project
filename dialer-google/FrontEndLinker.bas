...
' קבלת רשימת טבלאות משתמש - מחזיר שמות טבלאות שאינן מערכתיות
...
' ---------------------------------------------------------------------------
' קבלת נתיב BE - מחזיר את הנתיב לקובץ מסד הנתונים האחורי
...
' ---------------------------------------------------------------------------
' קישור ל-BE - מקשר טבלאות מקובץ מסד נתונים אחורי
Public Sub LinkToBE()
...
' ---------------------------------------------------------------------------
' חיבור מחדש ל-BE - מתקן קישורים שבורים לטבלאות מקושרות
Public Sub RelinkBE()
    On Error GoTo ErrHandler
    Dim bePath As String
    bePath = GetBEPath()
...
' ---------------------------------------------------------------------------
' חיבור אוטומטי בהפעלה - בודק ומתקן קישורי BE ב-startup
...
' ---------------------------------------------------------------------------
' אבחון חיבור BE - מדפיס מצב קישורים למסד הנתונים האחורי
