...
' מחיקת טבלה אם קיימת - מוחק טבלה בצורה בטוחה
...
' הגדרת ערך ברירת מחדל לשדה - קובע DefaultValue
...
' יצירת כל הטבלאות - יוצר את מבנה הטבלאות במסד
...
' יצירת אינדקסים - מוסיף אינדקסים לשיפור ביצועים
...
' הכנסת נתוני דוגמה - ממלא טבלאות בנתוני בדיקה
...
' יצירת תצוגות ושאילתות - יוצר Views מוכנים
...
' בדיקת הקמה - מוודא שכל הטבלאות נוצרו תקין
...
' איפוס מסד נתונים - מוחק ויוצר מחדש את כל הטבלאות
