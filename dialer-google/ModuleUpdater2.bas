...
Public Sub RunUpdate()
    ...
    SafeRemove "SyncPhoneBook"
    DoUpdate "SyncGoogleContacts", basePath
...
' ביצוע עדכון מודול - מחליף קוד מודול VBA מקובץ .bas
...
' הסרה בטוחה של מודול - מוחק מודול VBA אם קיים
...
' הבטחת גישה ל-VBE - מוודא שגישה תכנותית לפרויקט VBA מופעלת
...
' מציאת או יצירת מודול - מחזיר מודול VBA קיים או יוצר חדש
...
' קריאת קובץ ANSI 1255 - קורא קובץ טקסט בקידוד עברי
...
' הסרת שורות Attribute - מנקה מטא-דאטה של VBA מתוכן מודול
