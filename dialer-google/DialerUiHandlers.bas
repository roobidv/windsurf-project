...
' מקש למטה בחייגן - טיפול במקשי ניווט
...
' לחיצת מקש כללית - טיפול בתווי מקלדת
...
' ערך ברירת מחדל - מחזיר תחליף ל-Null
