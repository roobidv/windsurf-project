...
' יצירת קשרים בין טבלאות - מגדיר יחסי מפתח זר בין Contacts לטבלאות תלויות
...
' יצירה או החלפת קשר - יוצר Relation חדש, מוחק ישן אם קיים
...
' מחיקת קשר אם קיים - מסיר Relation לפי שם
...
' הבטחת קיום טבלת Contacts עם כל השדות
...
' בדיקת קיום שדה - מחזיר True אם השדה קיים בטבלה
...
' הבטחת קיום שדה - מוסיף שדה לטבלה אם חסר
...
' בדיקת קיום אינדקס - מחזיר True אם האינדקס קיים
...
' הבטחת קיום אינדקס - יוצר אינדקס אם חסר
