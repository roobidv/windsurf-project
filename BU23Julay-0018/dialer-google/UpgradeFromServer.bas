...
' ---------------------------------------------------------------------------
' שדרוג משרת - מייבא מודולים, טפסים, דוחות ושאילתות מקובץ BE
...
' ---------------------------------------------------------------------------
' ייבוא אובייקט - מייבא אובייקט בודד (מודול/טופס/דוח) משרת
...
' ---------------------------------------------------------------------------
' שדרוג מקובץ מקומי - מייבא אובייקטים מקובץ accdb מקומי
...
' ---------------------------------------------------------------------------
' ייבוא אובייקט מקומי - מייבא אובייקט בודד מקובץ מקומי
...
' ---------------------------------------------------------------------------
' ניקוי מודולים כפולים - מוחק מודולים עם סיומת מספרית (Module1 וכו')
