...
' מחיקת טופס אם קיים - מוחק טופס Access בצורה בטוחה
...
' בניית טופס חייגן ראשי - יוצר את הטופס המרכזי
...
' בדיקת שגיאה - בודק ומדפיס שגיאה אם יש
...
' יצירת פקד בטוחה - יוצר פקד בטופס עם טיפול בשגיאות
...
' בניית כפתורי מקלדת - יוצר כפתורי מספרים לחייגן
...
' בניית פקדי אנשי קשר - יוצר שדות תצוגת פרטי איש קשר
...
' בניית פקדי היסטוריה - יוצר תצוגת היסטוריית שיחות
