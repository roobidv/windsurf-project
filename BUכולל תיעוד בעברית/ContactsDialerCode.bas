...
' לחיצה על כפתור טלפון – מעתיק את מספר הטלפון ללוח (Clipboard)
...
' לחיצה על כפתור נייד – מעתיק את מספר הנייד ללוח (Clipboard)
...
Public Sub SetupContactsDialerForm()
    ...
    clrAccent = RGB(37, 99, 235)          ' כחול מודגש / blue accent
    ...
    clrPhone = RGB(5, 150, 105)           ' ירוק אמרלד לכפתור טלפון / emerald green
    clrLandline = RGB(75, 85, 99)         ' אפור צפחה לכפתור נייד / slate gray
    ...
    ' לחיצה מעתיקה מספר ללוח. טלפון בירוק, נייד באפור.
    ...
    ' ===== כפתור ייבוא מ-Excel (עיצוב בלבד – המשתמש ממקם ידנית) =====
...
' העתקת טקסט ללוח (Clipboard) באמצעות MSForms.DataObject (late binding).
